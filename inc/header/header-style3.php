...
<header id="back-header" class="single-header back-header-three <?php echo esc_attr($main_menu_center);?> <?php echo esc_attr($main_menu_icon);?>">
    <?php 
        ...
        <div class="back-table-wrap-logo">
            <div class="<?php echo esc_attr($header_width);?>">
                <div class="back-table-wrap">
                    <div class="back-cols">  
                        <div class="blog-date">
                            <i class="ri-calendar-line"></i> <?php echo date(get_option('date_format')); ?>
                        </div>
                    </div>
